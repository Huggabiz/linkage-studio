  ...
  const renderLoop = useCallback(() => {
    ...
    try {
      render(ctx, canvas, {
        ...
        arcSelector: editor.arcSelector ? { jointId: editor.arcSelector.jointId, position: editor.arcSelector.position, showTime: editor.arcSelector.showTime, collapseTime: editor.arcSelector.collapseTime } : null,
      });
    } catch (e) {
